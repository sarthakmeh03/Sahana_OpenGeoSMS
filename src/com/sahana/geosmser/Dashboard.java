...
public class Dashboard extends FragmentActivity {
    ...
    private SMSDeliveryDialog mDeliveryDialog;
...
//        mSMSQueryView.smsWriter.close();
	...
	protected void onPause() {
	 ...
	 private void setListensers() {
		 ...
		 //mSMSDeliveryView = (SMSDeliveryDialog) layoutInflaterFactory.inflate(R.layout.sms_delivery_dialog, null);
		 evtDialogDisableKeyBack = new DialogEvtDisableKeyBackOnKeyListener();
